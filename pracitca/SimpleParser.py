...
def serializedATN():
    with StringIO() as buf:
        ...
        buf.write("\7\5\2\2*,\3\2\2\2+\33\3\2\2\2+\36\3\2\2\2,\7\3\2\2\2")
...
class SimpleParser ( Parser ):
    ...
    def expr(self, _p:int=0):
        ...
        try:
            ...
            if la_ == 1:
                localctx = SimpleParser.FuncCallExprContext(self, localctx)
                self._ctx = localctx
                _prevctx = localctx
                ...
                localctx = SimpleParser.IntExprContext(self, localctx)
                self._ctx = localctx
                _prevctx = localctx
                self.state = 59
                ...
                localctx = SimpleParser.IdExprContext(self, localctx)
                self._ctx = localctx
                _prevctx = localctx
                self.state = 60
                self.match(SimpleParser.ID)
                ...
                localctx = SimpleParser.ParenExprContext(self, localctx)
                self._ctx = localctx
                _prevctx = localctx
                self.state = 61
                self.match(SimpleParser.T__5)
            ...
            while _alt!=2 and _alt!=ATN.INVALID_ALT_NUMBER:
                if _alt==1:
                    ...
                    if la_ == 1:
                        localctx = SimpleParser.MulDivExprContext(self, SimpleParser.ExprContext(self, _parentctx, _parentState))
                        ...
                        localctx = SimpleParser.AddSubExprContext(self, SimpleParser.ExprContext(self, _parentctx, _parentState))
                        self.pushNewRecursionContext(localctx, _startState, self.RULE_expr)
                        self.state = 70
